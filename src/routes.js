...
const Exam = React.lazy(() => import('./views/theme/colors/Exam'))
...
const routes = [
  ...
  { path: '/add', name: 'Add ', component: AddCompany },
  { path: '/edituser/:id', name: 'EditUser', component: EditUser },
  { path: '/exam', name: 'Exam', component: Exam },
  { path: '/company', name: 'Company', component: Company },
  { path: '/theme/exam', name: 'Exam', component: Exam },
  ...
  { path: '/editcompanyinformation', name: 'Company Information', component: EditCompanyInformation },

  { path: '/Companyinformation', name: 'Company Information', component: CompanyInfo },
  ...
  { path: '/edithr/:id', name: 'EditHR', component: EditHr },
  { path: '/edithr', name: 'EditHR', component: EditHr },
  { path: '/addcompanyinformation', name: 'Company Information', component: AddCompanyInfo },
